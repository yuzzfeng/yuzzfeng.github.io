...
Compare keyword based method and their own approach. SVM and sLDA (supervised) were used for training a binary classifier based on balanced dataset (2x36k).
